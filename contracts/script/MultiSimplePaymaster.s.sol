...
contract DeployMultiSimplePaymaster is Script, BaseDeployer {
    ...
    function chainDeployCounter() private broadcast(deployerPrivateKey) {
        ...
        SimplePaymaster simplePaymaster = new SimplePaymaster{salt: counterSalt}();

        require(create2addrCounter == address(simplePaymaster), "Address mismatch SimplePaymaster ");

        console2.log("SimplePaymaster address:", address(simplePaymaster), "\n");
    }
}
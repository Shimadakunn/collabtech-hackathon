  ...
  return ReactDom.createPortal(
    ...
    >
      <div
        ...
        className={`relative flex w-[300px] aspect-[16/6] group-data-[visible=true]:opacity-100 group-data-[visible=true]:visible group-data-[visible=false]:opacity-0 group-data-[visible=false]:invisible flex-col items-center justify-center rounded-base border-2 border-border dark:border-darkBorder bg-main p-6 pt-2 font-base shadow-light dark:shadow-dark transition-all duration-300 ${className}`}
      >
